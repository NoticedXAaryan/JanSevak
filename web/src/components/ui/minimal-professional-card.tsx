...
export const MinimalProfessionalCard = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col justify-center transition-colors duration-500">
            <div 
                ref={cardRef} 
                className={`w-full rounded-2xl p-8 transition-all duration-300 ease-out ${
                    isDarkMode 
