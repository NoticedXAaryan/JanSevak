...
async def send_whatsapp_message(to_number: str, body: str, media_url: str | None = None) -> bool:
    """
    ...
    payload = {"To": to_number, "From": settings.twilio_whatsapp_number, "Body": body}
